...
def playing11_builder():
    ...
    # Schema has no team_id in users table - get team from teams.owner_id
    ...
    return render_template('playing11.html', squad=squad, playing11=playing11, team_id=team_id)
